...
\begin{figure}[h]
  ...
  \caption{A reusable interposition hazard. A naive unversioned interposer of the glibc
    condition variable silently corrupts \emph{some} binaries (MariaDB crashes at startup) while
